...
vim.api.nvim_set_keymap('i', 'JK', '<esc>', { noremap = true, desc = "faz ter que digitar JK para sair do insert mode"})
vim.api.nvim_set_keymap('n', '<Space>', ':', { noremap = true, desc = "enter command-line (:) with space"})
vim.api.nvim_set_keymap('n', '<Space><Space>', '<cmd>lua require(\"snacks\").picker.smart()<CR>', { noremap = true, silent = true, desc = "smart find files (legacy)"})
vim.api.nvim_set_keymap('n', '<Space>/', '<cmd>lua require(\"snacks\").picker.grep()<CR>', { noremap = true, silent = true, desc = "grep (legacy)"})
