...
let g:colors_name = "hyper-marco"

hi Cursor ctermfg=24 ctermbg=231 cterm=NONE guifg=#cc00ff guibg=#ffffff gui=NONE
hi Visual ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#1c1c1c gui=NONE
...
hi Search ctermfg=17 ctermbg=255 cterm=bold guifg=#00005f guibg=#eeeeee gui=bold
